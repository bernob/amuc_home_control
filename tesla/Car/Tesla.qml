...
//        }
        ...
        Item {
            ...
            Image {
                ...
                source: "images/trunk_open_newred.png"
            }
            MouseArea {
                id: trunk_mouse_area
            ...
            Image {
                ...
                source: "images/trunk_closed_newred.png"
            }
            Image {
                id: frunk_open
                ...
                source: "images/frunk_open_newred.png"
            }
            MouseArea {
                id: frunk_mouse_area
            ...
            Image {
                ...
                anchors.topMargin: 40
                source: "images/frunk_closed_newred.png"
            }
            Image {
                id: sunroof_closed
                ...
                anchors.topMargin: 0
                source: "images/sunroof_closed.png"
            }
            Image {
                id: sunroof_open
                ...
                anchors.leftMargin: 265
                anchors.topMargin: 0
                source: "images/sunroof_open.png"
            }
            MouseArea {
            ...
            Image {
                ...
                anchors.leftMargin: 265
                anchors.topMargin: 0
                source: "images/sunroof_vent.png"
            }
            Image {
                ...
                source: "images/left_front_open_newred.png"
            }
            MouseArea {
            ...
            Image {
                ...
                source: "images/left_front_closed_newred.png"
            }
            Image {
                ...
                source: "images/left_rear_open_newred.png"
            }
            MouseArea {
            ...
            Image {
                ...
                source: "images/left_rear_closed_newred.png"
            }
            Image {
                ...
                source: "images/charge_cable_long.png"
            }
            Image {
                ...
                source: "images/charge_port_on.png"
            }
            Image {
                id: charge_port_open
                ...
                anchors.topMargin: 135
                source: "images/charge_port_open.png"
            }
            Image {
                id: climate_car_cold
                ...
                scale: 0.35
                source: "images/climate_car_cold.png"
            }
            Image {
                id: climate_car_hot
                ...
                anchors.topMargin: -20
                scale: 0.35
                source: "images/climate_car_hot.png"
            }
        }
    }
    Timer {
